...
It's inspired by [#90DaysOfDevOps](https://github.com/Anuj2402/90DaysOfDevOps), but it runs **weekly instead of daily**. AWS is best learned by going deep on a group of services, building something with them, and then explaining it back to someone. A week gives you room to do all three. 
